...
const AddBooking = function ({navigation }) {  
  const clearItem = { userID: userID(),place: '', name: '', emailid: '', contact: '', person: '1', datetime: '', bookingtime: '7 AM - 8 AM', trnsctype: 'customerBooking', isDateTimePickerVisible:false }
