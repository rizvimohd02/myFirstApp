...
const BusinessStackOptions = ({navigation}) => {
  return ({
    headerRight: () => (
      <Button
        onPress={() => navigation.navigate('Manage Staff')}
        title='Manage Staff'
      />
    )
  });
...
const BusinessStackLayout = () => (
  <Stack.Navigator>
    <Stack.Screen name='Register Business' component={RegisterBusiness} options={BusinessStackOptions} />
