...
<View style={styles.splitView}>
        <View style={styles.timingArea,{width: 170, borderColor: '#1e90ff',borderWidth: 1,borderRadius: 10}}>
          <Text style={styles.label,{paddingLeft:10}}>Opening Time</Text>
          <PickerSelect
        ...
        <View style={styles.timingArea,{width: 170, borderColor: '#1e90ff',borderWidth: 1,borderRadius: 10}}>
          <Text style={styles.label,{paddingLeft:10}}>Closing Time</Text>
          <PickerSelect
            style={{inputIOS: styles.selector }}
